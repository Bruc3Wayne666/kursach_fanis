...
export default function MessagesScreen() {
    ...
    //             c.type === chat.type &&
    //             c.partner?.id === chat.partner?.id
    //         )
    // );

    // Оставляем все чаты без фильтрации
        ...
        <>
            <SafeAreaView style={styles.container} edges={['top']}>
                ...
                <FlatList
                    ...
                    keyExtractor={item => `${item.type}-${item.partner?.id}-${item.isFriendChat ? 'friend' : 'chat'}-${forceUpdate} ${Math.random()}`}
